...
if __name__ == '__main__':
    ...
    test_residual_plots_t1()
    test_residual_plots_t2()
    test_residual_plots_t3()
    test_residual_plots_t4()
    test_residual_plots_t5()
    ...
    if passed == total:
        print(f"  {GREEN}{BOLD}All tests PASSED [v]{RESET}")
    else:
        print(f"  {RED}{BOLD}{total - passed} test(s) FAILED [x]{RESET}")
    print('='*58)
